...
function buildPlot() {
  ...
  d3.json(url).then(function(response) {
     ...
     console.log(response[0]);
        ...
        var y_pred = response[0].y_pred;
        var y_test = response[0].y_test;
        var dates = y_pred.Date;
        console.log(dates);
...
// // Load data from URL
// d3.json('https://dknowles52-app1.herokuapp.com/api/btc').then(function(forceData) {
